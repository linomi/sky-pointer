...
LIB_test_C_API 
bool MW_CALL_CONV mlfTest(int nargout, mxArray** outputArg1, mxArray** outputArg2, 
                          mxArray* inputArg1, mxArray* inputArg2)
{
    return mclMlfFeval(_mcr_inst, "test", nargout, 2, 2, outputArg1, outputArg2, inputArg1, inputArg2);
}
